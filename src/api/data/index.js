...
const query = params => instance.get(`/api/ruban-cds/widgetParamSource/singleWidgetSource`, {  params })
...
const queryPageWidgetsDataBind = params =>  instance.get(`/api/ruban-cds/widgetParamSource/allWidgetBindData`, { params })
