    ...
    <div class="main-con">
      ...
      >
        <a-form-model
          ...
          :wrapper-col="{ span: 12 }"
        >
          <a-form-model-item ref="studioName" label="应用名称" prop="studioName">
          <a-input
      ...
      <a-table :columns="columns" :data-source="data"  rowKey='id' style="width:100%">
        <a slot="studioName" @click="() => jump(record)" slot-scope="text, record">{{ text }}</a>
